...
function load_image(gallery_name,image_number,max_number_of_images,image_count)
{
   ...
   image_html = '<a href="display_image.html?image_file_name='+image_path+'" target="_self" style="overflow: visible"><img src="'+image_path+'" class="art_image border_radius"></a>';
