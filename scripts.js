...
const gallery_list = [{name: "featured_work",  title: "Gallery",        min_image_number: 3, max_image_number: 22, new_list: [3,4,5]},
...
function openJL(url) {
  ...
  link.href = url;
  link.target = 'JL'; // Targets the existing window named "JL"
  document.body.appendChild(link);
  link.click(); // This forces the browser to treat it as a new navigation
...
// Step 1: Open the window normally
let winJL = window.open("https://www.sfvacc.org/layers-2026", 'JL');

// Step 2: Use assign() for the second call to force a history entry
if (winJL) {
    winJL.location.assign("https://www.sfvacc.org/layers-2026?itemId=o3zmxgklm7y4dcu95mx82qpkelbv3x");
}
/*
     JL = window.open("https://www.sfvacc.org/layers-2026","Exhibition 1");
    JL.history.pushState(null, '', "https://www.sfvacc.org/layers-2026");

const sleep = ms => new Promise(resolve => setTimeout(resolve, ms));


sleep(5000).then(() => {
    JL.location.href = 'https://www.sfvacc.org/layers-2026?itemId=o3zmxgklm7y4dcu95mx82qpkelbv3x';
});
