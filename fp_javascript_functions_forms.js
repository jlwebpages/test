...
function build_regular_season_form()
{
   ...
   {
      d.writeln('<div style="font-family: Calibri, sans-serif; font-size: 12pt; text-align: center; margin: 10px 5px 5px 5px; padding-bottom: 250px; display: block"><b>Open Date:</b>&nbsp;&nbsp;'+open_date+'</div>');
   }
